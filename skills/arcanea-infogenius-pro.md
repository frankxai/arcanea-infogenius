...
triggers:
  ...
  - "arcanea diagram image"
  - "guardian architecture visual"
mcp_required: [nano-banana, arcanea-mcp]
guardian_agents: [@vision-artist, @dragon-forge, @crystal-architect, @void-gazer]
---
...
## Arcanea Visual Identity System

### Elemental Color Palette
```
Primary Arcanea Colors:
- Dragon Fire: #FF6B35 (transformation, power)
- Ocean Depth: #2E86AB (wisdom, flow)
- Earth Foundation: #4A5759 (stability, structure)
...
### Visual Fusion Style
- Clean enterprise layouts with mythical elemental accents
- Guardian sigils integrated as service identifiers
- Data flows represented as elemental energy streams
- Strategic use of Arcanea mythology for conceptual representation

## Enhanced Generation Patterns

### Pattern 1: Guardian Architecture Overview
```
Prompt Template:
...
### Pattern 2: Elemental Comparison Infographic
```
Prompt Template:
...
Target: Strategic decision-makers seeking both data and inspiration."
```

### Pattern 3: Guardian Process Flow
```
Prompt Template:
"Create a Guardian-enhanced process flow for [PROCESS].
Style: Step-by-step journey with Arcanea mythology woven throughout.
Guardians: [SPECIFIC_GUARDIANS] guiding each phase.
Elements: Color-code by elemental influence (Fire=action, Water=flow, Earth=stability, Wind=communication, Void=innovation).
Include: Transformation milestones, wisdom checkpoints, success metrics.
Format: Mythical quest map with enterprise annotations."
```

### Pattern 4: Transcendent Data Architecture
```
Prompt Template:
...
Include: Guardian blessing markers, data quality sigils, performance omens."
```

## Guardian Agent Integration

### @vision-artist Enhancement
- **Visual Aesthetics:** Artistic composition, color harmony, symbolic depth
- **Use Cases:** Executive presentations, marketing materials, brand visuals
- **Signature Style:** Ethereal beauty with technical precision

### @dragon-forge Transformation
- **Creative Destruction:** Bold redesigns, innovative layouts, breakthrough thinking
- **Use Cases:** Disruptive architecture presentations, transformation roadmaps
- **Signature Style:** Fiery energy with calculated risk-taking

### @crystal-architect Structure
- **Systematic Design:** Precise layouts, clear hierarchies, optimized structure
- **Use Cases:** Technical documentation, system overviews, implementation guides
- **Signature Style:** Geometric precision with multifaceted clarity

### @void-gazer Innovation
- **Futuristic Vision:** Cutting-edge concepts, paradigm-shifting visuals
- **Use Cases:** Innovation showcases, future architecture, R&D presentations
- **Signature Style:** Mysterious depth with infinite possibilities

## Advanced Command Usage

### Basic Guardian Enhancement
```bash
/arcanea-visual "Cloud transformation journey" --guardian=@dragon-forge
```

### Multi-Guardian Collaboration
```bash
/arcanea-visual "Multi-cloud data platform" --guardians=@crystal-architect,@ocean-memory --elemental=water,earth
```

### Executive Presentation Mode
```bash
/arcanea-visual "AI factory architecture" --audience=executive --style=transcendent --resolution=4K
```

### Technical Documentation
```bash
/arcanea-visual "Microservices ecosystem" --style=technical --guardian=@crystal-architect --format=documentation
```

## MCP Integration Architecture

### Enhanced Nano Banana Server
```json
{
  "mcpServers": {
    "arcanea-infogenius": {
...
### Arcanea Excellence Checklist

**Mythical Integration:**
- [ ] Guardian sigils appropriately placed
- [ ] Elemental colors meaningfully applied
...
- [ ] Selected Guardian's expertise clearly visible
- [ ] Creative adds value, not complexity
- [ ] Elemental symbolism purposeful
- [ ] Innovation balanced with practicality

## Arcanea Resource Integration

**Guardian Agents:**
- Full integration with all 38 Arcanea Guardians
...
- Research-grounded architecture patterns
- Current best practices and future trends
